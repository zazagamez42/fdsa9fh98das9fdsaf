...
do
    ...
    Utility.SaveConfig = function(Config)
        writefile(
            "piehaxx/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json", 
    ...
    Utility.LoadConfig = function(Config)
        local Config = HttpService:JSONDecode(readfile("piehaxx/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json"))
        --
...
do
    function Library.CreateLoader(Title, WindowSize)
        ...
        --
        Library.Theme.Logo = Utility.AddImage("piehaxx/Assets/UI/Logo2.png", "https://i.imgur.com/HI4UTmZ.png")
        --
        ...
        --
        Utility.AddFolder("piehaxx")
        Utility.AddFolder("piehaxx/Caches")
        Utility.AddFolder("piehaxx/Assets")
        Utility.AddFolder("piehaxx/Assets/UI")
        Utility.AddFolder("piehaxx/Configs")
        Utility.AddFolder("piehaxx/Scripts")
        --
        Library.Theme.Gradient = Utility.AddImage("piehaxx/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        -- Library.Theme.SecondIcon = Utility.AddImage("piehaxx/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        Library.Theme.Hue = Utility.AddImage("piehaxx/Assets/UI/Hue.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/HuePicker.png")
        Library.Theme.Saturation = Utility.AddImage("piehaxx/Assets/UI/Saturation.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/SaturationPicker.png")
        Library.Theme.SaturationCursor = Utility.AddImage("piehaxx/Assets/UI/HueCursor.png", "https://raw.githubusercontent.com/mvonwalk/splix-assets/main/Images-cursor.png")
        --
        Library.Theme.Astolfo = Utility.AddImage("piehaxx/Assets/UI/Astolfo.png", "https://i.imgur.com/T20cWY9.png")
